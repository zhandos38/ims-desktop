  ...
  <div>
    ...
    <div class="menu">
      <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3">
          <router-link class="menu-link" to="/order">
            <div class="menu-link__container">
              <div class="menu-link__icon">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3">
          <router-link class="menu-link" to="/shift">
            <div class="menu-link__item">
              <div class="menu-link__icon">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3">
          <router-link class="menu-link" to="/cashbox-transactions">
            <div class="menu-link__item">
              <div class="menu-link__icon">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3">
          <router-link class="menu-link" to="/date-report">
            <div class="menu-link__item">
              <div class="menu-link__icon">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3">
          <router-link class="menu-link" to="/return-report">
            <div class="menu-link__item">
              <div class="menu-link__icon">
                <i class="far fa-calendar-alt" aria-hidden="true"></i>
              </div>
