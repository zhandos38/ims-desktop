  ...
  <div class="wrapper">
    <div class="site-login__form">
      ...
      <form action="#" @submit.prevent="submitHandler">
        <div class="form-group" :class="{'has-error': ($v.username.$dirty && !$v.username.required)}">
          <input
            class="form-control"
            type="text"
            id="username"
        ...
        <div class="form-group"  :class="{'has-error': ($v.password.$dirty && !$v.password.required) || ($v.password.$dirty && !$v.password.minLength)}">
          ...
          />
          <small class="help-block-error" v-if="$v.password.$dirty && !$v.password.minLength">Пароль должен состоять как минимум из 6 символов</small>
        </div>
        ...
        <div class="form-group">
          <router-link class="site-login__button" to="/signup">Регистрация</router-link>
        </div>
